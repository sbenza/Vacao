...
/**
 * Entity mapped to table VaccineControl.
 */
public class VaccineControl {
    ...
    private transient VaccineControlDao myDao;
    ...
    public VaccineControl(Long id) {
        this.id = id;
    }

    public VaccineControl(Long id, String comment, String dose, java.util.Date date, long cattleId, long vaccineId) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getVaccineControlDao() : null;
    }
