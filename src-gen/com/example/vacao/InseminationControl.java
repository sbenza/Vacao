...
/**
 * Entity mapped to table InseminationControl.
 */
public class InseminationControl {

    private Long id;
    private String comment;
    private java.util.Date date;
    private long cattleId;
    private long bullOriginId;

    /** Used to resolve relations */
    private transient DaoSession daoSession;

    /** Used for active entity operations. */
    private transient InseminationControlDao myDao;

    private Cattle cattle;
    private Long cattle__resolvedKey;


    public InseminationControl() {
    }

    public InseminationControl(Long id) {
        this.id = id;
    }

    public InseminationControl(Long id, String comment, java.util.Date date, long cattleId, long bullOriginId) {
        this.id = id;
        this.comment = comment;
        this.date = date;
        this.cattleId = cattleId;
        this.bullOriginId = bullOriginId;
    }

    /** called by internal mechanisms, do not call yourself. */
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getInseminationControlDao() : null;
    }
    ...
    public long getBullOriginId() {
        return bullOriginId;
    }

    public void setBullOriginId(long bullOriginId) {
        this.bullOriginId = bullOriginId;
    }
