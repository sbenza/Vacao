...
/**
 * Entity mapped to table PalpationControl.
 */
public class PalpationControl {
    ...
    private transient PalpationControlDao myDao;

    private Cattle cattle;
    private Long cattle__resolvedKey;


    public PalpationControl() {
    }

    public PalpationControl(Long id) {
        this.id = id;
    }

    public PalpationControl(Long id, Boolean pregnant, String comment, java.util.Date date, long cattleId) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getPalpationControlDao() : null;
    }
